        ...
        try {
            ...
            mqttClient.setCallback(new MqttCallback() {
                ...
                public void messageArrived(String topic, MqttMessage message) throws Exception {
                    ...
                    try {
                        ...
                        ConsolidatedValues conso = consolidation.get("temperature");
                        if (conso == null) {
                        ...
                        System.out.printf("average temperature: %f (%d samples)\n", conso.getAverage(),
                                conso.getSampleCount());

                        if (System.currentTimeMillis() > endMinute) {
                            System.out.println("end of minute, PUBLISH CONSOLIDATION");
                            ...
                            for (Map.Entry<String, ConsolidatedValues> e : consolidation.entrySet()) {
                                ...
                                topicPub = String.format("greenhouse/CONSOLIDATED/benjamin/data/%s/%d/%02d/%d/%d/%d",
                                        e.getKey(), c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1,
            ...
            mqttClient.connect(null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    try {
                        mqttClient.subscribe("javaonedemo/eclipse-greenhouse/sensors/temperature", 1);
